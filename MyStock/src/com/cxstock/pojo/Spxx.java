...
public class Spxx implements java.io.Serializable {
	...
	/** full constructor */
	public Spxx(String spid,String spname, String xinghao, String tuhao, Integer lbid, String lbname,
			String dw, Double jhprice, Double chprice, Double scjj,
			Integer kcsl, Double kczj, Integer minnum, String csname,String cktype,
