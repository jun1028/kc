...
CREATE TABLE `bsdsp` (
  ...
  `djid` varchar(14) NOT NULL,
  `spid` varchar(20) NOT NULL COMMENT '产品id',
...
CREATE TABLE `spxx` (
  ...
  `tuhao` varchar(20) default '0001' COMMENT '图号',
...
INSERT INTO `menu` VALUES ('1050', '当前库存查询', '10', '../kucun/kcsearch.jsp', '0', '5', 'menu-14');
...
INSERT INTO `menu` VALUES ('3010', '产品报损', '30', '../kucun/baosun.jsp', '0', '1', 'menu-31');
INSERT INTO `menu` VALUES ('3020', '产品报溢', '30', '../kucun/baoyi.jsp', '0', '2', 'menu-32');
...
INSERT INTO `menu` VALUES ('3050', '零铺消耗库存查询', '30', '../kucun/tpkcsearch.jsp', '0', '5', 'menu-34');
INSERT INTO `menu` VALUES ('3060', '原材料库存查询', '30', '../kucun/yckcsearch.jsp', '0', '6', 'menu-34');
INSERT INTO `menu` VALUES ('3070', '半成品库存查询', '30', '../kucun/bchkcsearch.jsp', '0', '7', 'menu-34');
INSERT INTO `menu` VALUES ('3080', '成品库存查询', '30', '../kucun/chpkcsearch.jsp', '0', '8', 'menu-34');
...
INSERT INTO `menu` VALUES ('4030', '产品采购统计', '40', '../tongji/spcgtj.jsp', '0', '3', 'menu-43');
INSERT INTO `menu` VALUES ('4040', '产品销售统计', '40', '../tongji/spxstj.jsp', '0', '4', 'menu-44');
INSERT INTO `menu` VALUES ('4050', '按日统计分析-销售额', '40', '../tongji/tjfxri.jsp', '0', '5', 'menu-45');
INSERT INTO `menu` VALUES ('4060', '按月统计分析-销售额', '40', '../tongji/tjfxyue.jsp', '0', '6', 'menu-46');
...
INSERT INTO `menu` VALUES ('5030', '产品管理', '50', '../ziliao/spxx.jsp', '0', '3', 'menu-53');
...
INSERT INTO `menu` VALUES ('6040', '产品图片管理', '60', '../kucun/tpshq.jsp', '0', '4', 'menu-36');
